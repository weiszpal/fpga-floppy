...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Weisz Pál}
\newcommand{\vikkonzulens}{Horváth Kristóf}
\newcommand{\vikcim}{Commodore floppy meghajtó\\megvalósítása FPGA-val}
\newcommand{\viktanszek}{Méréstechnika és Információs Rendszerek Tanszék}
\newcommand{\vikdoktipus}{MSc Önálló laboratórium 2.}
\newcommand{\vikdepartmentr}{Weisz Pál}
...
\include{project}
\tableofcontents
\include{cpt1_bevezeto}
\include{cpt2_fpga_interface}
\include{cpt3_fejlesztes_fpga}
\include{cpt4_teszteles}
