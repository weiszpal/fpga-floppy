...
A bináris állomány rendelkezésemre állt, ugyanarról a weboldalról elérhetõ, ahol a 1581-es szervizkönyvét is megtaláltam. Mivel a verilog hex fájlt vár a \$readmemh paramétereként, át kellett alakítanom a bináris állományt a megfelelõ formátumúra. Linux alatt a következõ bash-szkripttel tettem ezt meg:
...
\section{Top modul}
összekötések, címdekóder, ready logika a floppyhoz kimenetek visszakapcsolása a bemenetre a CIA-n
felhúzó ellenállások megvalósítása
